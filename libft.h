...
/*   Updated: 2024/07/03 17:35:56 by antoda-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// @brief 		Checks for a SIGN character.
/// @param c	Character to check
/// @return 	1 if c is a sign, 0 otherwise
int				ft_issign(char c);

/// @brief 		Checks for a WHITE SPACE character.
/// @param c	Character to check
/// @return 	1 if c is a space, 0 otherwise
int				ft_isspace(int c);

/// @brief 		Checks for a NUMERIC string.
/// @param str	Pointer to string
/// @return		Pointer to the first non-space character
int				ft_isnum(char *str);

/// @brief 		Fills memory pointed by 's' with char 'c' x n bytes.
...
int				ft_pf_nbr_fega_exp_value(t_printf *f, char *arg_arr, \
				char *str, void *arg);
...
int				ft_pf_nbr_fega_mantissa(t_printf *f, char dot, \
...
/* ft_pf_tools1.c */
void			ft_pf_nbr_any_signal(t_printf *f, void *arg);
...
void			ft_fputhexa(unsigned int nbr, const char *f,
					int *count, int fd);
